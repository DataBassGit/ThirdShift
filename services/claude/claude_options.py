...
class SelectOptions():
    def __init__(self, api_key=None, prompt=None, model="claude-v1", max_tokens=8000, stop_sequence=None, stream=True, temperature=1, top_k=1, top_p=1, metadata=None):
        """
        ...
        :param max_tokens: int, the maximum number of tokens to output
